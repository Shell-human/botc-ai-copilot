...
export const TRANSLATIONS = {
    zh: {
        ...
        apiConfigTip: "请输入您的 API 密钥以启用推理分析。您输入的所有密钥都仅保存在本地浏览器缓存中。",
    ...
    en: {
        ...
        apiConfigTip: "Please enter your API Key to enable reasoning analysis. All credentials are strictly saved in your local browser cache.",
